...
--- @param opts? table<string, any> # is_lua: only search lua subdirs
...
--- @param ns_id number # namespace to use or -1 for ungrouped highlight
--- @param hl_group string # Name of the highlight group to use
--- @param line number # Line to highlight (zero-indexed)
--- @param col_start number # Start of (byte-indexed) column range to highlight
--- @param col_end number # End of (byte-indexed) column range to highlight, or -1 to
...
--- @param buffer buffer # Buffer handle, or 0 for current buffer
--- @param fun fun() # Function to call inside the buffer (currently lua callable
--               only)
...
--- @param buffer buffer # Buffer handle, or 0 for current buffer
--- @param ns_id number # Namespace to clear, or -1 to clear all namespaces.
--- @param line_start number # Start of range of lines to clear
--- @param line_end number # End of range of lines to clear (exclusive) or -1 to
...
--- @param buffer buffer # Buffer handle, or 0 for current buffer
--- @param opts? table<string, any> # Optional parameters. Currently not used.
...
--- @param buffer buffer # Buffer handle, or 0 for current buffer
--- @param start_row number # First line index
--- @param start_col number # Starting column (byte offset) on first line
--- @param end_row number # Last line index, inclusive
--- @param end_col number # Ending column (byte offset) on last line, exclusive
...
--- @param buffer buffer # Buffer handle, or 0 for current buffer
--- @param ns_id number # Namespace id from |nvim_create_namespace()|
--- @param line number # Line where to place the mark, 0-based. |api-indexing|
--- @param col number # Column where to place the mark, 0-based. |api-indexing|
--- @param opts? table<string, any> # Optional parameters.
...
--- @param col number # Column/row number
...
--- @param chan number # id of the channel
...
--- @param opts? table<string, any> # Parameters
...
--- @see |nvim_exec()|
--- @see |nvim_command()|
--- @param cmd? table<string, any> # Command to execute. Must be a Dictionary that can contain the
...
--- @param opts? table<string, any> # Dictionary Parameters
...
--              autocommand
--- @param opts? table<string, any> # Dictionary of autocommand options:
...
--                  |nvim_parse_cmd()|.
--- @param opts? table<string, any> # Optional command attributes. See |command-attributes| for
...
--- @param id number # Integer The id of the group.
...
--- @param id number # Integer The id returned by nvim_create_autocmd
...
--- @param opts? table<string, any> # Dictionary with at least one of the following:
...
--- @param opts? table<string, any> # Optional parameters. Currently only supports {"builtin":false}
--- @return any # Map of maps describing commands.
...
--- @param hl_id number # Highlight id as returned by |hlID()|
...
--- @param grid number # Grid number if the client uses |ui-multigrid|, else 0.
--- @param row number # Mouse row-position (zero-based, like redraw events)
--- @param col number # Mouse column-position (zero-based, like redraw events)
...
--- @param log_level number # The log level
...
--- @param config? table<string, any> # Map defining the window configuration. Keys:
...
--- @param phase number # -1: paste in a single call (i.e. without streaming). To
...
--- @param item number # Index (zero-based) of the item to select. Value of -1
...
--- @param ns_id number # Namespace id from |nvim_create_namespace()|
--- @param opts? table<string, any> # Table of callbacks:
...
-- 
--- @param ns_id number # Namespace id for this highlight |nvim_create_namespace()|.
--              Use 0 to set a highlight group globally |:highlight|.
--- @param name string # Highlight group name, e.g. "ErrorMsg"
--- @param val? table<string, any> # Highlight definition map, accepts the following keys:
...
--- @param ns_id number # the namespace to use
...
--- @param ns_id number # the namespace to activate
...
--- @param opts? table<string, any> # Optional parameters map: keys are |:map-arguments|, values are
...
--- @param fun fun() # Function to call inside the window (currently lua callable
--               only)
--- @return any # Return value of function. NB: will deepcopy lua values currently, use
--     upvalues to send lua references in and out.
...
--- @see |nvim_open_win()|
--- @param window window # Window handle, or 0 for current window
--- @param config? table<string, any> # Map defining the window configuration, see |nvim_open_win()|
...
--- @param window window # Window handle, or 0 for current window
--- @param height number # Height as a count of rows
...
-- vertically.
--- @param window window # Window handle, or 0 for current window
--- @param width number # Width as a count of columns
