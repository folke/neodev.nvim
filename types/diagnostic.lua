...
--- @param opts any #(table|nil) When omitted or "nil", retrieve
...
--- @param list any[] #(table) A list of quickfix items from
...
--- @param bufnr any #(number|nil) Buffer number to get diagnostics
...
-- buffer.
--- @param opts any #(table) See |vim.diagnostic.goto_next()|
--- @return any #(table) Previous diagnostic position as a (row, col)
---     tuple.
...
--- @param defaults any #(table|nil) Table of default values for
...
---                    namespaces.
--- @param bufnr any #(number|nil) Buffer number, or 0 for
---                    current buffer. When omitted, show
---                    diagnostics in all buffers.
--- @param diagnostics any #(table|nil) The diagnostics to display.
